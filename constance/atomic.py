...
Int8ul = api.Atomic(_lib.Int8ul, python_type=int, cast=ord)
Int8ub = api.Atomic(_lib.Int8ub, python_type=int, cast=ord)
Int8un = api.Atomic(_lib.Int8un, python_type=int, cast=ord)
...
Int16ul = api.Atomic(_lib.Int16ul, python_type=int, cast=ord)
Int16ub = api.Atomic(_lib.Int16ub, python_type=int, cast=ord)
Int16un = api.Atomic(_lib.Int16un, python_type=int, cast=ord)
...
Float32l = api.Atomic(_lib.Float32l, python_type=int)
Float32b = api.Atomic(_lib.Float32b, python_type=int)
Float32n = api.Atomic(_lib.Float32n, python_type=int)
Float64l = api.Atomic(_lib.Float64l, python_type=int)
Float64b = api.Atomic(_lib.Float64b, python_type=int)
Float64n = api.Atomic(_lib.Float64n, python_type=int)
